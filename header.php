...
<html lang="en-US">
   ...
   <body background="black" style = "font-size:12px;font:Helvetica;">
      <!-- TOP NAV WITH LOGO -->  
      <div style="margin-top:0%;background:#040606;">
         <img src="/new_batch_marketing/img/nbm_cover_jpeg.jpg"style = "height:10%;width:800px;margin-left:10%;"> 
      </div>
      <header>
         <nav style ="margin-top:18.1%;background:#00191C;">
            <div class="line">
               <div class="top-nav">              
                        ...
                        <li><a>REPORTS</a>
                           <ul class="right top-ul chevron">
                              ...
                              <li><a href="/new_batch_marketing/reports/stock_inventory.php">INVENTORY</a></li>
                               ...
                               <li><a href="/new_batch_marketing/reports/custome_order_list.php">CUSTOMER ORDER</a></li>
