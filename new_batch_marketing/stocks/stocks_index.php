...
<?php
	...
	echo '<form method = "post" action = "http://localhost:8080/new_batch_marketing/stocks/stocks_index.php">';

	$new_batch_marketing = new Db();
	

				echo '<div style = "align:right;margin-right:150%;margin-top:-93%;margin-left:-300%;">';
				echo '<h1>STOCKS<h1>';
				echo '</div>';
				echo '<div><hr style= "width:550%;margin-right:0%;margin-top:-2%;margin-left:-235%"></div>';
				...
				echo'<div class="form-group">
					 ...
					 <div class="col-lg-10">
				     <select class="form-control" id="product_code" name = "product_code" style = "width: 200%;border-radius:2px;">
				...
				<input style = "width: 200%;border-radius:2px;" type="submit" class="form-control"name = "view" id = "view" value = "VIEW"></br>
				<input style = "width: 200%;border-radius:2px;" type="submit" class="form-control"name = "submit" id = "submit" value = "UPDATE">
				</div>
				</div>';
				echo '</div>';
...
<p style="margin-left:1%;">"Boostrap CDN by"
<a href="http://tracking.maxcdn.com/c/99191/3982/378">
<img src ="templates/login template/maxcdn-logo.png"/></a>.</p>
<hr/>
<p  style="margin-left:1%;">Themes and templates licensed under the <a href="http://www.apache.org/licenses/LICENSE-2.0">Apache License v2.0</a>.
