...
$details = $_SESSION['container'];
    ...
    echo '<form method = "post" action = "http://localhost:8080/new_batch_marketing/agent/agent_update.php"?>';
    ...
    if(isset($_POST['update'])){
        ...
        $update_agent = $new_batch_marketing->query("UPDATE agent SET `lastname` = '$lastname', `firstname` = '$firstname',`contact_num`='$contact',`area` = $area WHERE `agent_id` = $id");
    ...
    echo '<div style = "align:left;;margin-top:7%;margin-left:10%;width:90%;">
          <h1>UPDATE AGENT<h1></div>';
    ...
    echo'<td><input type ="text" name = "id" class = "form-control" placeholder = "ID" value= "'.$id.'" style = "width:23%;border-radius:2px;" readonly = "readonly"></td></br>
        <td><input type ="text" name = "lastname" class = "form-control" placeholder = "Lastname" value= "'.$lastname.'" style = "width:23%;border-radius:2px;"></td></br>
         ...
         <td><input type ="text" name = "area" class = "form-control" placeholder = "area" value= "'.$area.'" style = "width:23%;"  readonly = "readonly"></td></br>
         ...
         <td><input type ="submit" name = "cancel" class = "form-control" value= "CANCEL" style = "width:23%;background:#30493D;color:white;border-radius:2px;"></td></br>';
    echo'</div>';
  echo '</form>';
