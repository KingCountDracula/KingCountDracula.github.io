...
function printpage()
  ...
  window.print()
				...
				$print.='</table></div>';
		                ...
		                <input style = "width: 20%;border-radius:2px;background:#30493D;color:white;" type = "submit" name = "confirm" value = "CONFIRM" class = "form-control"></br>
	...
	echo'</div>';
	 // <input type="button" value="PRINT" onclick="printpage()"style = "width: 20%;border-radius:2px;background:#30493D;color:white;"class = "form-control" name = "print"></br>
?>
