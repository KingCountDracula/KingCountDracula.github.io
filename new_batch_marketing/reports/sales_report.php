...
$pdate = date('Y-m-d',strtotime('-1day'));
// $pdate = '2016-09-13';
$total_sales = '';
...
echo '<h1>SALES OF THE DAY('.date("F-d-Y",strtotime("-1day")).')<h1></div>';
echo '<div><hr style= "width:90%;margin-right:0%;margin-top:-1%;margin-left:5%"></div>';

$infos = $new_batch_marketing->query("SELECT * FROM `sales` WHERE `date` = '$pdate'");
	...
	echo'<div style = "margin-top:16%;margin-left:70%;float;">TOTAL SALES:php&nbsp;'.$total_sales.'</a></div>';
	echo'<div style = "margin-top:1%;margin-left:70%;float;"><a href = "all_sales.php">VIEW ALL SALES</a></div>';
