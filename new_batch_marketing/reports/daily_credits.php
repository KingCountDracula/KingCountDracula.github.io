...
$total_credit_sales = '';
    ...
    echo '<div style = "align:left;;margin-top:6%;margin-left:10%">
          <h1>CREDIT TRANSACTIONS OF THE DAY('.date("F-d-Y",strtotime("-1day")).')<h1></div>';
...
WHERE co.status =  'CREDIT' AND delivery_date = '$current_date'");
     ...
     // print_r($receivables);
        ...
        if(empty($credits_of_the_day)){
         ...
         echo'</table></div></br>';
          echo'<div style = "margin-top:1%;margin-left:70%;float;">TOTAL CREDITS:php&nbsp;'.$total_credit_sales.'</div>';
          echo'<div style = "margin-top:1.5%;margin-left:70%;float;"><a href = "all_credits.php">VIEW ALL CREDITS</a></div>';
